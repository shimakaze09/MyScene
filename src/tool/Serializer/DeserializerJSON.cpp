...
namespace My::detail::DeserializerJSON_ {
template <typename T>
...
using namespace My::detail::DeserializerJSON_;

class My::MyJsonValue {
 public:
  MyJsonValue(const rapidjson::Value* data) : data{data} {}
...
class My::MyJsonDoc {
 public:
  MyJsonDoc(rapidjson::Document* data) : data{data} {}
...
Scene* DeserializerJSON::ParseScene(const MyJsonDoc* doc) {
  if (!(**doc).IsObject() || !(**doc).HasMember("type") ||
      (**doc)["type"] != Reflection<Scene>::Instance().Name().data()) {
    cerr << "ERROR::DeserializerJSON::DeserializeScene:" << endl
...
void DeserializerJSON::ParseSObj(Scene* scene, SObj* sobj,
                                 const MyJsonValue* value) {
  if (!(**value).IsObject() || !(**value).HasMember("type") ||
      (**value)["type"] != Reflection<SObj>::Instance().Name().data()) {
    cerr << "ERROR::DeserializerJSON::DeserializeScene:" << endl
...
void DeserializerJSON::ParseObj(void* obj, const MyJsonValue* value) {
  ...
  for (const auto& member : (**value).GetObject()) {
    ...
    if (ReflectionMngr::Instance().GetReflction(obj)->FieldMeta(
            string(member.name.GetString()), ReflAttr::not_serialize) ==
        ReflAttr::default_value)
      continue;
...
template <typename T>
void My::detail::DeserializerJSON_::DeserializeArray(
    T& arr, const rapidjson::Value& value) {
...
void My::detail::DeserializerJSON_::Set(bool& property,
                                        const rapidjson::Value& value) {
  property = value.GetBool();
}

void My::detail::DeserializerJSON_::Set(float& property,
                                        const rapidjson::Value& value) {
  property = static_cast<float>(value.GetDouble());
}

void My::detail::DeserializerJSON_::Set(double& property,
                                        const rapidjson::Value& value) {
  property = value.GetDouble();
}

void My::detail::DeserializerJSON_::Set(int8_t& property,
                                        const rapidjson::Value& value) {
  property = value.GetInt();
}

void My::detail::DeserializerJSON_::Set(int16_t& property,
                                        const rapidjson::Value& value) {
  property = value.GetInt();
}

void My::detail::DeserializerJSON_::Set(int32_t& property,
                                        const rapidjson::Value& value) {
  property = value.GetInt();
}

void My::detail::DeserializerJSON_::Set(int64_t& property,
                                        const rapidjson::Value& value) {
  property = value.GetInt64();
}

void My::detail::DeserializerJSON_::Set(uint8_t& property,
                                        const rapidjson::Value& value) {
  property = value.GetUint();
}

void My::detail::DeserializerJSON_::Set(uint16_t& property,
                                        const rapidjson::Value& value) {
  property = value.GetUint();
}

void My::detail::DeserializerJSON_::Set(uint32_t& property,
                                        const rapidjson::Value& value) {
  property = value.GetUint();
}

void My::detail::DeserializerJSON_::Set(uint64_t& property,
                                        const rapidjson::Value& value) {
  property = value.GetUint64();
}

template <typename T>
void My::detail::DeserializerJSON_::Set(T& property,
                                        const rapidjson::Value& value) {
  DeserializeArray(property, value);
}

template <typename T>
void My::detail::DeserializerJSON_::Set(std::vector<T>& property,
                                        const rapidjson::Value& value) {
