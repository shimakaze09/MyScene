...
#include <MyScene/tool/Accel/LinearBVHNode.h>

using namespace My;
using namespace std;

void LinearBVHNode::InitLeaf(const bboxf3& box, int shapesOffset,
                             int shapesNum) {
  this->box = box;
...
void LinearBVHNode::InitBranch(const bboxf3& box, int secondChildIdx,
                               Axis axis) {
  this->box = box;
