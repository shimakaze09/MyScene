...
void TriMesh::InitCubeMesh() {
  vector<pointf3> positions = {
      pointf3{-1.f, -1.f, -1.f}, pointf3{-1.f, 1.f, -1.f},
      pointf3{1.f, -1.f, -1.f},  pointf3{1.f, 1.f, -1.f},
      pointf3{-1.f, -1.f, 1.f},  pointf3{1.f, -1.f, 1.f},
      pointf3{-1.f, 1.f, 1.f},   pointf3{1.f, 1.f, 1.f},
      pointf3{-1.f, -1.f, 1.f},  pointf3{-1.f, 1.f, 1.f},
  ...
  vector<normalf> normals = {
      normalf{-1.0f, 1.0f, 0.0f}, normalf{-1.0f, 1.0f, 1.0f},
      normalf{-1.0f, 0.0f, 0.0f}, normalf{-1.0f, 0.0f, 1.0f},
      normalf{1.0f, 0.0f, 0.0f},  normalf{1.0f, 1.0f, 0.0f},
      normalf{1.0f, 0.0f, 1.0f},  normalf{1.0f, 1.0f, 1.0f},
      normalf{0.0f, 1.0f, 0.0f},  normalf{0.0f, 1.0f, 1.0f},
      normalf{0.0f, 0.0f, 0.0f},  normalf{0.0f, 0.0f, 1.0f},
      normalf{0.0f, 0.0f, 1.0f},  normalf{0.0f, 0.0f, 0.0f},
      normalf{0.0f, 1.0f, 1.0f},  normalf{0.0f, 1.0f, 0.0f},
      normalf{0.0f, 1.0f, 1.0f},  normalf{0.0f, 0.0f, 1.0f},
      normalf{0.0f, 1.0f, 0.0f},  normalf{0.0f, 0.0f, 0.0f},
      normalf{0.0f, 0.0f, 0.0f},  normalf{0.0f, 1.0f, 0.0f},
      normalf{0.0f, 0.0f, 1.0f},  normalf{0.0f, 1.0f, 1.0f},
  };
  ...
  vector<pointf2> texcoords = {
      pointf2{0.0f, 0.0f},  pointf2{0.0f, 0.0f},  pointf2{0.0f, 0.0f},
      pointf2{0.0f, 0.0f},  pointf2{0.0f, 0.0f},  pointf2{0.0f, 0.0f},
      pointf2{0.0f, 0.0f},  pointf2{0.0f, 0.0f},  pointf2{-1.0f, 0.0f},
      pointf2{-1.0f, 0.0f}, pointf2{-1.0f, 0.0f}, pointf2{-1.0f, 0.0f},
      pointf2{1.0f, 0.0f},  pointf2{1.0f, 0.0f},  pointf2{1.0f, 0.0f},
      pointf2{1.0f, 0.0f},  pointf2{0.0f, -1.0f}, pointf2{0.0f, -1.0f},
      pointf2{0.0f, -1.0f}, pointf2{0.0f, -1.0f}, pointf2{0.0f, 1.0f},
      pointf2{0.0f, 1.0f},  pointf2{0.0f, 1.0f},  pointf2{0.0f, 1.0f},
  };
